...
% Calculate hours
hours = fix(UTSEC / 3600);
remaining_seconds = mod(UTSEC, 3600);

% Calculate minutes
minutes = fix(remaining_seconds / 60);

% Calculate seconds
seconds = mod(remaining_seconds, 60);

% Display the results
fprintf('Epoch >>Hours: %d, Minutes: %d, Seconds: %.2f\n', hours, minutes, seconds);
