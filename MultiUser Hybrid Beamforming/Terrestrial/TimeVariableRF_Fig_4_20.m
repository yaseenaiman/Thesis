...
time_HP_FD_ZF=zeros(1,length(NtRf)); % fully digital  ZF precoding spectral efficiency
time_HP_FD_MSE=zeros(1,length(NtRf)); % fully digital  MMSE precoding spectral efficiency
time_HP_ayash = zeros(1,length(NtRf)); %  OMP_Ayash Spectral Efficiency
time_HP_Yu = zeros(1,length(NtRf)); %  Proposed Algorithm Spectral Efficiency 
