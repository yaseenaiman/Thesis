...
NtRf = 18;%number of transmitter RF chains
...
Rate_HP_FD_ZF=zeros(1,length(Num_users)); % fully digital hybrid ZF precoding spectral efficiency
Rate_HP_FD_MSE=zeros(1,length(Num_users)); % fully digital hybrid MMSE precoding spectral efficiency
...
for iter=1:1:ITER
    ...
    [H,a_TX,a_RX]=generate_channels(Num_users(useri),TX_ant_w,TX_ant_h,RX_ant_w,RX_ant_h,Num_paths); 
