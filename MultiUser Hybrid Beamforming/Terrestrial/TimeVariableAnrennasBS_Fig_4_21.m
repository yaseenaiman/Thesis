...
Rate_HP_FD_ZF=zeros(1,length(TX_ant)); % fully digital  ZF precoding spectral efficiency
Rate_HP_FD_MSE=zeros(1,length(TX_ant)); % fully digital  MMSE precoding spectral efficiency
Rate_HP_ayash = zeros(1,length(TX_ant)); %  OMP_Ayash Spectral Efficiency
Rate_HP_Yu = zeros(1,length(TX_ant)); %  Proposed Algorithm Spectral Efficiency 
