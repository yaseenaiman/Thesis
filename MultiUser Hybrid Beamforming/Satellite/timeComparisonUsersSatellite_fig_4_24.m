...
time_HP_Yu = zeros(1,length(Num_users)); %  Novel Algorithm Spectral Efficiency 
...
for iter=1:1:ITER
    ...
    [H,a_TX,a_RX]=generate_channels(Num_users(count),TX_ant_w,TX_ant_h,RX_ant_w,RX_ant_h,Num_paths, fc, Hight, Re, Rs); 
